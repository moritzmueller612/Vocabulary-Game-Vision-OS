...
struct ContentView: View {
    ...
    @State private var cameraYaw: Float = 0.0 // Drehung der Kamera
    private let windowPositionZ: Float = -1.5 // Z-Position des Fensters
    ...
    var body: some View {
        RealityView { content, attachments in
            ...
            if let zStackAttachment2 = attachments.entity(for: "ZStackAttachment2") {
                zStackAttachment2.position = [0, 1.6, 0 - windowPositionZ]
